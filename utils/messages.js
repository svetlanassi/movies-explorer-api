...
const MSG_ERR_INCORRECT_DATA = 'Переданы некорректные данные';
const MSG_ERR_CONFLICT = 'Пользователь с таким email уже зарегистрирован!';
...
const MSG_SUCCESSFUL_AUTH = 'Успешная авторизация!';
const MSG_DELETE_TOKEN = 'Токен удален';
const MSG_DELETE_MOVIE = 'Фильм удален';
const MSG_LIMITER = 'Слишком много запросов, пожалуйста, повторите попытку позже.';
